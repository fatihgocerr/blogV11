                                  ...
                                  /* $a="14531453";
                                   ...
                                   if (pisset()) {
                                    ...
                                    if ($kullanici=="" or $sifre=="") {
                                        ...
                                        $db->sql ="select * from tb_member where member_username =? and member_password =? and member_confirmation =? and ( member_authorization =? or member_authorization =? )";
                                        ...
                                        if ($uye != false) {                                    
                                          ...
                                          $_SESSION["admin"]=true;
                                          $_SESSION["member_name"] =$uye->member_name;
                                          $_SESSION["member_authorization"] =$uye->member_authorization;
                                          header("location:<?php echo URL; ?>index.php");
                                          exit();
                                      }
                                      else{
