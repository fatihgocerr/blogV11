                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$no++?></td>
                                            <td><?php echo $value->content_header; ?></td>
                                            <td><?php echo $value->hit; ?></td>
                                            <td> 
                                                <a href="index.php?url=icerik_guncelle&id=<?=$value->content_id;?>" class="btn btn-info" onclick="return confirm('İçeriği düzenlemek istediğinizden emin misiniz?');">Düzelt</a> <!-- return ile onaya sunduk-->
                                                <a href="index.php?url=icerik_sil&id=<?=$value->content_id;?>" class="btn btn-danger"class="btn btn-info" onclick="return confirm('İçeriği SİLMEK istediğinizden emin misiniz?');">Sil</a>
                                            </td>
