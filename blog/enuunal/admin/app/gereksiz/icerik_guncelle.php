            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                   <div class="col-lg-12">
                    ...
                    $icerik_baslik=$icerik->content_header;
                    $icerik_aciklama=$icerik->content_description;
                    $icerik_detay=$icerik->content_detail;
                    $icerik_kat_id=$icerik->content_category_id;
                    ...
                    if (pisset()) {
                        ...
                        if ($icerik_kategori=="" and $icerik_baslik =="") {
                           echo'<div class="alert alert-warning">
                            ...
                            $db->sql ="update tb_content set content_header =?, content_description=?, content_detail=?, content_category_id=?, date_update=? where content_id=?";
                                            ...
                                            <select class="form-control" name="icerik_kategori">
                                                ...
                                                if ($kategoriler !=false) {
                                                   foreach ($kategoriler as $key => $value) {
                                                    if ($icerik_kat_id==$value->category_id) {
                                                        $selected="selected";
                                                    }
                                                    else{$selected="";}
                                                    echo '<option value="' . $value->category_id . '"'.$selected.'>'.$value->category_header.'</option>';   
                                                }
                                            }
                                            ?>
                                        </select>
