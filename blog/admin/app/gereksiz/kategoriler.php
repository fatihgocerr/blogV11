                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$no++?></td>
                                            <td><?php echo $value->category_header; ?></td>
                                            <td> 
                                                <a href="index.php?url=kategori_guncelle&id=<?=$value->category_id;?>" class="btn btn-info">Düzelt</a>
                                                <a href="index.php?url=kategori_sil&id=<?=$value->category_id;?>" class="btn btn-danger" onclick="return confirm('İçeriği SİLMEK istediğinizden emin misiniz?');">Sil</a>
                                            </td>
