                ...
                <div class="row">
                   <div class="col-lg-12">
                    ...
                    if (pisset()) {
                        ...
                        $db->sql ="update tb_experience set experience_title =?, experience_company =?, experience_img=?, experience_content=?, experience_period =?,mounth =?, eng=?  where experience_id=?";
                        $db->veri = array($deneyim_baslik, $deneyim_sirket,$deneyim_img,$deneyim_aciklama, $deneyim_sure, $deneyim_ay, $dil, $id);
                        $guncelle=$db->update();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="dil" id="tr" value="0" >TR
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="dil" id="en" value="1">EN
                                                    </label>
