                ...
                <div class="row">
                   <div class="col-lg-12">
                    ...
                    if (pisset()) {
                        ...
                        $db->sql ="insert into  tb_experience set experience_title =?, experience_company =?, experience_img=?, experience_content=?, experience_period =?,mounth =?, eng=? ";
                        $db->veri = array($deneyim_baslik, $deneyim_sirket,$deneyim_img,$deneyim_aciklama, $deneyim_sure, $deneyim_ay,$dil);
                        $ekle=$db->insert();
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="dil" id="tr" value="0" checked>TR
                                                    </label>
                                                    <label class="radio-inline">
