...
?>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Operasyon Müdürü,Masal Park,Vialand,Eğlence Sektörü</span><strong class="text-slider"></strong></p>
        ...
        <div class="col-sm-3 col-lg-3">
          <div class="counter-box">
            ...
            <div class="counter-num">
              ...
              <span class="counter-text">Tamamlanan proje</span>
            </div>
          </div>
        </div>
        <div class="col-sm-3 col-lg-3">
          <div class="counter-box pt-4 pt-md-0">
            ...
            <div class="counter-num">
              ...
              <span class="counter-text">Yıllık Deneyim</span>
            </div>
          </div>
        </div>
        <div class="col-sm-3 col-lg-3">
  ...
  <section id="work" class="portfolio-mf sect-pt4 route">
    <div class="container">
      ...
      <div class="row">
        <?php 
        $db->sql="select * from tb_experience order by experience_id desc limit 6 ";
